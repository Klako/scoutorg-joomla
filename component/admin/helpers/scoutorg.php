...
class ScoutOrgHelper {
    ...
    public static function addSubMenu(string $view) {
        JHtmlSidebar::addEntry(Text::_('COM_SCOUTORG_ADMIN_BRANCHES'), 
            'index.php?option=com_scoutorg&view=branches',
            $view == 'branches');
        JHtmlSidebar::addEntry(Text::_('COM_SCOUTORG_ADMIN_TROOPS'),
            'index.php?option=com_scoutorg&view=troops',
            $view == 'troops');
        JHtmlSidebar::addEntry(Text::_('COM_SCOUTORG_ADMIN_USERPROFILEFIELDS'),
